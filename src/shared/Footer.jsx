...
const Footer = () => {
    return (
            ...
            <footer className="py-6 dark:bg-gray-100 dark:text-gray-900 border-2 w-11/12 mx-auto bg-blue-400 text-white lora">
                <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
                    <div className="grid grid-cols-12">
                        <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                                ...
                                <p><span className='text-xs lg:text-base'>Stay informed with the latest news and updates from trusted sources</span></p>
                        ...
                        <div className="col-span-6 md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li>
                                    <a rel="noopener noreferrer" href="/allArticles" className="hover:dark:text-violet-600 text-xs lg:text-base">All Articles</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="/addArticles" className="hover:dark:text-violet-600 text-xs lg:text-base">Add Article</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="/subscription" className="hover:dark:text-violet-600 text-xs lg:text-base">Subscription</a>
                                </li>
                                
                                <li>
                                    <a rel="noopener noreferrer" href="/myProfile" className="hover:dark:text-violet-600 text-xs lg:text-base">Profile</a>
                                </li>
                            </ul>
                        </div>
                    </div>
