    ...
    return (
        ...
        <div className='my-10 lg:my-20 border-2'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 p-4'>
                {/* card-1 */}
                <div className=" p-6 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900 border-2 border-pink-300 space-y-4">
                    <button className='btn bg-pink-300'>Free for 1 month</button>
                ...
                {/* card-2 */}
                <div className=" p-6 rounded-md shadow-md border-2 border-amber-300">
                    
                    <div className='flex justify-between mb-10'>
                        <h3 className='text-xl font-bold'>Premium Due</h3>
                        <div>
                ...
                {/* card-3 */}
                <div className=" p-6 rounded-md shadow-md border-blue-400 border-2">
                    <div className='flex justify-between'>
                        <h3 className='font-bold'>Premium Family</h3>
                        <div>
                            <p>$16.99</p>
                            <p>per month</p>
                        </div>
                    ...
                    <div>
                        <button className='btn bg-blue-300'><Link to='/subscription'>Get Premium family</Link></button>
